...
eval("// removed by extract-text-webpack-plugin\n\n//# sourceURL=webpack:///./src/page/list/index.css?");
...
eval("module.exports = \"{{#list}} <li class=\\\"list-item-container\\\"> <div class=\\\"item-img-container\\\"> <a href=\\\"./detail.html?productId={{id}}\\\" class=\\\"link\\\"> <img src=\\\"{{imageHost}}{{mainImage}}\\\" alt=\\\"{{name}}\\\" class=\\\"list-item-img\\\"> </a> </div> <div class=\\\"item text-container\\\"> <a href=\\\"./detail.html?productId={{id}}\\\" class=\\\"link\\\"> <div class=\\\"item-price\\\">￥{{price}}</div> <div class=\\\"item-name\\\">{{name}}</div> <div class=\\\"item-subtitle\\\">{{item-subtitle}}</div> </a> </div> </li> {{/list}}\";\n\n//# sourceURL=webpack:///./src/page/list/list.string?");
...
eval("// removed by extract-text-webpack-plugin\n\n//# sourceURL=webpack:///./src/util/pagination/index.css?");
...
eval("module.exports = \"<div class=\\\"pg-content\\\"> {{#pageArray}} {{#disabled}} <span class=\\\"pg-item disabled\\\" data-value=\\\"{{value}}\\\">{{name}}</span> {{/disabled}} {{^disabled}} {{#active}} <span class=\\\"pg-item active\\\" data-value=\\\"{{value}}\\\">{{name}}</span> {{/active}} {{^active}} <span class=\\\"pg-item\\\" data-value=\\\"{{value}}\\\">{{name}}</span> {{/active}} {{/disabled}} {{/pageArray}} <span class=\\\"pg-total\\\">{{pageNum}} / {{pages}}</span> </div>\";\n\n//# sourceURL=webpack:///./src/util/pagination/index.string?");
